        ...
        If MessageBox.Show("Are you sure you want to continue?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
            If MyDataGridView.RowCount > 0 Then
                For i = 0 To MyDataGridView.RowCount - 1
                    ...
                    com.CommandText = "insert into tbldochistory set refcode='" & trncode.Text & "',remarks='Added attachment " & MyDataGridView.Rows(i).Cells("File Name").Value() & "', historydate=current_timestamp, historyby='" & globaluserid & "'" : com.ExecuteNonQuery()
                Next
            End If
